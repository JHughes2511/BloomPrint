...
const makeStyles = (t: ThemeTokens) => StyleSheet.create({
  ...
  box: { backgroundColor: t.sheet, borderTopLeftRadius: 20, borderTopRightRadius: 20, paddingHorizontal: 20, paddingTop: 18, paddingBottom: 20, height: '90%', width: '100%', maxWidth: CONTENT_MAX_WIDTH, alignSelf: 'center'},
