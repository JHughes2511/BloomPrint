...
export default function SummaryScreen() {
  ...
  const buildHtml = () => `
    <html><head><meta charset="utf-8"/><style>
      ...
      h1 { font-size: 20px; }
      h3 { font-size: 14px; border-bottom: 1px solid #eee; padding-bottom: 4px; margin-top: 20px; color: #333; }
      p, li { font-size: 13px; line-height: 1.8; }
    </style></head><body>
      <h1>${sanitize(title)}</h1>
      <div style="white-space:pre-wrap;font-size:12px;line-height:1.8;color:#444">${sanitize(reportText)}</div>
