    ...
    <PageContainer maxWidth={900}>
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        ...
        <KeyboardAwareScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 22, paddingBottom: 40 }} keyboardShouldPersistTaps="handled">
          {fieldKey ? (
            <>
              <Text style={styles.title} numberOfLines={2} adjustsFontSizeToFit minimumFontScale={0.75}>{tr(`onboarding.fields.${fieldKey}.label`)}</Text>
            ...
            <>
              <Text style={styles.title} numberOfLines={2} adjustsFontSizeToFit minimumFontScale={0.75}>{tr('onboarding.joinTeamTitle')}</Text>
