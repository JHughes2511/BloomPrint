...
SHELL: dict[str, dict[str, str]] = {
    ...
    "sr": {
        ...
        "reset_cta": "Izaberite novu lozinku",
        "undo_cta": "Zadrži moj nalog",
        "claim_cta": "Preuzmi ovaj tim",
        ...
        "decide_expired": "Ova veza je istekla. Otvorite BloomPrint da odgovorite.",
        "decide_failed": "Nešto nije u redu. Otvorite BloomPrint da odgovorite.",
        "signoff": "BloomPrint",
        "unsub": "Ne želite ovo? Isključite: {url}",
        "unsub_note": "Poruke o vašem nalogu i dalje ćete primati.",
        "contact": "Pitanja? Pišite nam na",
        "account_ready": "Vaš nalog je spreman.",
        "unsub_link": "odjavi se",
        "unsub_done_title": "Odjavljeni ste",
        "unsub_done_body": "Više nećete dobijati imejlove o aktivnosti drugih. Poruke o vašem nalogu i dalje će se slati.",
    },
    "hr": {
        "greeting": "Bok {name},",
        "open_cta": "Otvori BloomPrint",
